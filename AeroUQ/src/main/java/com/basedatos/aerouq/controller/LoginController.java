...
public class LoginController {
    ...
    private void abrirDashboard(ActionEvent event, String usuario, String rol) {
        try {
            String fxmlPath;
            // Si el usuario es Cliente, carga dashboardUsuario.fxml
            if ("Cliente".equalsIgnoreCase(rol)) {
                fxmlPath = "/com/basedatos/aerouq/dashboardUsuario.fxml";
            } else {
                // Para otros roles, usa el dashboard general
                fxmlPath = "/com/basedatos/aerouq/dashboard.fxml";
            }
